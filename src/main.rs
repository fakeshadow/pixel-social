...
fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(web::scope("/async/user")
                .service(web::resource("/register").route(web::post().to_async(router::user::register_user_async)))
                .service(web::resource("/login").route(web::post().to_async(router::user::login_user_async)))
                .service(web::resource("/{id}").route(web::get().to_async(router::user::get_user_async)))
                .service(web::resource("/").route(web::post().to_async(router::user::update_user_async))))
            ...
            .service(web::scope("/async/topic")
                .service(web::resource("/").route(web::post().to_async(router::topic::add_topic_async)))
                .service(web::resource("/edit").route(web::post().to_async(router::topic::update_topic_async)))
                .service(web::resource("/{topic_id}/{page}").route(web::get().to_async(router::topic::get_topic_async))))
